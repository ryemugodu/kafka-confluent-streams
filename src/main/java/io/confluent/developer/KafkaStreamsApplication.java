...
public class KafkaStreamsApplication {
    ...
    public static void main(String[] args) throws Exception{
        ...
        try(Util utility = new Util()){
            utility.createTopics(props,
                Arrays.asList(new NewTopic(inputTopic,Optional.empty(), Optional.empty()), 
                                new NewTopic(outputTopic,Optional.empty(), Optional.empty())));

            try(Util.Randomizer rando = utility.startRandomizer(props, inputTopic)){
